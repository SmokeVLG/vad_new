...
<tr>
    ...
    <td class=".td_so_drsu" style="text-align: left; color: red" ><?php 
...
if($data['rf_idOrg'] == 1)echo("ДСУ - 1 (Гумрак)");
    ...
    <td class=".td_so_drsu" style="text-align: left;"> <?php echo 0;?> </td>  
        
       <td class=".td_so_drsu" style="text-align: left;"> <?php echo 'Ямочный ремонт';?> </td>  
</tr>
