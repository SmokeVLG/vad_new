<h1>Мониторинг по ДРСУ (Факт)</h1>
<?php $time = date('d-m-Y', strtotime(date('d-m-Y', strtotime(date('d-m-Y'))) . ' -1 day')); echo $time; ?>
...
$this->widget('zii.widgets.CListView', array(
        ...
        'itemView'=>'application.views.backend.site.monitoring._soDrsuYamremFact2',
        'template'=>'{items}',
        'pager'=>array(),
...
$this->widget('zii.widgets.CListView', array(
        ...
        'itemView'=>'application.views.backend.site.monitoring._soDrsu2YamremFact2',
        'template'=>'{items}',
        'pager'=>array(),
