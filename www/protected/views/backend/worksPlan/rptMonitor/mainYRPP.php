...
<body>
<h3>Информация о выполнении ямочного ремонта (План) <?php  echo $dateRep; ?> по  <?php  echo $dateRep3; ?> </h3>
	...
	<tbody>
		<tr>
			...
			<td rowspan="2">Дорожноу управление</td>
                        <td rowspan="2">Время подачи</td>
                        <td rowspan="2">За какое число</td>
         ...
         <?php for($i=0; $i<count($dataOrg); $i++) { ?>
                ...
                <tr>
                    ...
                    <?php if($dataSO[$j]['OrgID'] == $dataOrg[$i]['id']) { ?>
                        ...
                        <td><?php  echo $dataSO[$j]['datePlan']; ?></td>
