...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>
        ...
        <div class="row">
            <?php echo $form->labelEx($model, 'rf_idRoadsBuild'); ?>
            
             
            <?php echo $form->textArea($model, 'rf_idRoadsBuild', array('size'=>20,'maxlength'=>300)); ?>
            
            <?php echo $form->error($model,'rf_idRoadsBuild'); ?>
...
Yii::app()->clientScript->registerScript('forgroads', 'js:
        ...
        function()
            {
                ...
                $("#Work_rf_idRoads").bind
                    (
                        "change keyup", function ()
                            {            
                                a = $("#Work_rf_idRoads option:selected").text();
    ...
    {
        var roadSelect = $("#Work_rf_idRoads");        
