...
$this->breadcrumbs=array(
	'Дорожные работы(Факт)'=>array('index'),
	'Обзор Дорожных работ (Факт)',
);

$this->menu=array(
	array('label'=>'Список Дорожных работ(Факт)', 'url'=>array('index')),
	array('label'=>'Создать Дорожную работу(Факт)', 'url'=>array('create')),
);
...
$('.search-form form').submit(function(){
	$.fn.yiiGridView.update('works-fact-grid', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Список Дорожных работ(Факт)</h1>
