<h1>Мониторинг по объектам обслуживания</h1>
...
<table class="so_mon">    
	...
	<td class="h_so_cnt" style="text-align: right;"><?php echo $dataSumProvider[0]['cPOGR']; ?></td>
        ...
        <td class="h_so_cntWish" style="text-align: right;"><?php echo $dataSumProvider[0]['obstanovka']; ?></td> 
    </tr>
<?php
...
$this->widget('zii.widgets.CListView', array(
        ...
        'itemView'=>'application.views.frontend.site.monitoring._so',
        'template'=>'{items}',
        'pager'=>array()
