...
/**
 * This is the model class for table "t_work_gsm".
 *
 * The followings are the available columns in table 't_work_gsm':
 * @property integer $id
 ...
 */
class WorksGsm extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return WorkGsm the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('toplivo, benzin, karti,', 'type','type' => 'float'),
