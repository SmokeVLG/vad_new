...
/**
 * This is the model class for table "t_works_fact".
 *
 * The followings are the available columns in table 't_works_fact':
 * @property integer $id
 ...
 */
class WorksFact extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return WorksFact the static model class
	 */
